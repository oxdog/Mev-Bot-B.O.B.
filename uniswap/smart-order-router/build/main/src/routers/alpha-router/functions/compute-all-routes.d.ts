...
export declare function computeAllRoutes<TPool extends Pair | Pool, TRoute extends V3Route | V2Route>(tokenIn: Token, tokenOut: Token, buildRoute: (route: TPool[], tokenIn: Token, tokenOut: Token) => TRoute, pools: TPool[], maxHops: number): TRoute[];
